...
public class ProfileButtonController : MonoBehaviour {
    ...
    private void UpdateActive() {
        ...
        if (_icon != null) _icon.color = active ? ThornModule.Instance!.Accent.Value.GetCurrentColor() : Color.white;
        if (_nameText != null) {
            _nameText.color = active ? ThornModule.Instance!.Accent.Value.GetCurrentColor() : Color.white;
